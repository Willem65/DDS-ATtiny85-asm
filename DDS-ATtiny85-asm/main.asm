...
;T0_start:
		...
		ldi		r16,0b11010110	; ADC_start			; ADC init single conversion prescale 16:
		out 	ADCSRA, r16		; ADEN ADSC ADATE ADIF ADIE ADPS2 ADPS1 ADPS0: ADCSRA
...
;***************************************************************************
		...
		ldi 	r16,0b00000011		;TCCR0B: FOC0A FOC0B – – WGM02 CS02 CS01 CS00
